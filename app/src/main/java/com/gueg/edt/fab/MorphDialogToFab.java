...
public class MorphDialogToFab extends ChangeBounds {
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put(PROPERTY_COLOR, view.getContext().getResources().getColor(R.color.dialog_background_color));
    ...
    public void captureEndValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put(PROPERTY_COLOR, view.getContext().getResources().getColor(R.color.fab_background_color));
